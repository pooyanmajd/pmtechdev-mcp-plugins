...
| --- | --- | --- | --- |
| [Mailbridge for Apple Mail](plugins/mailbridge-mcp/README.md) | Search, read, manage state, create drafts, and explicitly send through accounts configured in macOS Mail. | macOS | [`0.6.1`](https://github.com/pooyanmajd/pmtechdev-mcp-plugins/releases/tag/v0.6.1) |
...
For the reviewed, immutable release, pin the marketplace to Mailbridge `0.6.1` instead:
...
The [immutable `0.6.1` release](https://github.com/pooyanmajd/pmtechdev-mcp-plugins/releases/tag/v0.6.1) includes the plugin tarball, SHA-256 checksums, a CycloneDX SBOM, and signed GitHub provenance attestations.
